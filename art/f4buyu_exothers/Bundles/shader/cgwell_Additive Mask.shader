  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          c_1.xyz = float3(tmpvar_2.xyz);
          c_1.w = (tmpvar_2.w * tex2D(_Mask, in_f.xlv_TEXCOORD1).x).x;
          float4 tmpvar_3;
          float _tmp_dvx_4 = ((2 * in_f.xlv_COLOR) * (_TintColor * c_1));
          tmpvar_3 = float4(_tmp_dvx_4, _tmp_dvx_4, _tmp_dvx_4, _tmp_dvx_4);
